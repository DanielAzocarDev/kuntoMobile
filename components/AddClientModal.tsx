...
import type { CreateClientPayload } from "../interfaces/client.interfaces";
      ...
      <View style={styles.container}>
        <View style={styles.header}>
          <View style={styles.headerContent}>
            <Ionicons name="person-add-outline" size={28} color="#f59e0b" />
            <Text style={styles.headerTitle}>Añadir Nuevo Cliente</Text>
          </View>
          <TouchableOpacity
            onPress={handleClose}
